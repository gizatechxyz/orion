...
mod tensor_1D {
    ...
    use orion_tests::helpers::tensor::fixed_point::fp8x23::fp_tensor_1x3_helper;
...
mod tensor_2D {
    use orion::operators::tensor::implementations::tensor_fp8x23::FP8x23Tensor;
    use orion::operators::tensor::core::TensorTrait;
    use orion_tests::helpers::tensor::fixed_point::fp8x23::fp_tensor_2x2_helper;
    use orion::numbers::fixed_point::implementations::fp8x23::core::FP8x23Impl;
    use orion::numbers::fixed_point::core::{FixedTrait};
...
mod tensor_3D {
    use orion::operators::tensor::implementations::tensor_fp8x23::FP8x23Tensor;
    use orion::operators::tensor::core::TensorTrait;
    use orion_tests::helpers::tensor::fixed_point::fp8x23::fp_tensor_2x2x2_helper;
    use orion::numbers::fixed_point::implementations::fp8x23::core::FP8x23Impl;
    use orion::numbers::fixed_point::core::{FixedTrait};
