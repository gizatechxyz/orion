...
mod matrix_statistics {
    ...
    fn exponential_weights_test {
        ...
        assert(FixedTrait::abs(X.get(0, 0).unwrap() - FixedTrait::<FP16x16>::new(1907, false)) < ERROR_THRESHOLD, 'X_2 incorrect'); // ~0.029
        assert(FixedTrait::abs(X.get(0, 0).unwrap() - FixedTrait::<FP16x16>::new(1850, false)) < ERROR_THRESHOLD, 'X_3 incorrect'); // ~0.028
    }
    ...
    fn 2D_mean_weighted_test_i {
        ...
        let mut mu_X = mean_weighted(ref X, ref weights, 0);
    ...
    fn 2D_mean_weighted_test_ii {
        ...
        let mut mu_X = mean_weighted(ref X, ref weights, 1);
    ...
    fn covariance_weighted_test {
        ...
        let mut sigma2_X = covariance_weighted(ref X, ref weights);
