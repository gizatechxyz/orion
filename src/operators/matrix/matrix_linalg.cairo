...
use orion::numbers::fixed_point::implementations::fp16x16::core::{
    FixedTrait, FP16x16, FP16x16Add, FP16x16Div, FP16x16Mul, FP16x16Sub, FP16x16Impl
};
...
trait MatrixLinalgTrait<T> {
    ...
    fn linalg_solve(ref X: MutMatrix<T>, ref y: MutMatrix<T>) -> MutMatrix<T>;
}

impl FP16x16MatrixLinalgImpl of MatrixLinalgTrait<FP16x16> {
