...
use orion::operators::tensor::math::sinh::sinh_i32::fp8x23;
use orion::operators::tensor::math::sinh::sinh_i32::fp16x16;

/// Cf: TensorTrait::sinh docstring
fn sinh_i32(self: @Tensor<i32>) -> Option<Tensor<FixedType>> {
    match *self.extra {
