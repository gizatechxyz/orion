...
use orion::operators::tensor::math::asinh::asinh_fp::fp8x23;
use orion::operators::tensor::math::asinh::asinh_fp::fp16x16;

/// Cf: TensorTrait::asinh docstring
fn asinh(self: @Tensor<FixedType>) -> Option<Tensor<FixedType>> {
    match *self.extra {
