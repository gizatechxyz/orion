...
use orion::operators::tensor::math::asinh::asinh_i8::fp8x23;
use orion::operators::tensor::math::asinh::asinh_i8::fp16x16;

/// Cf: TensorTrait:asinh docstring
fn asinh_i8(self: @Tensor<i8>) -> Option<Tensor<FixedType>> {
    match *self.extra {
