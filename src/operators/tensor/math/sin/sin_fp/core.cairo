...
use orion::operators::tensor::math::sin::sin_fp::fp8x23;
use orion::operators::tensor::math::sin::sin_fp::fp16x16;

/// Cf: TensorTrait::sin docstring
fn sin(self: @Tensor<FixedType>) -> Option<Tensor<FixedType>> {
    match *self.extra {
