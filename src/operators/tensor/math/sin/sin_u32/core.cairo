...
use orion::operators::tensor::math::sin::sin_u32::fp8x23;
use orion::operators::tensor::math::sin::sin_u32::fp16x16;

/// Cf: TensorTrait::sin docstring
fn sin_u32(self: @Tensor<u32>) -> Option<Tensor<FixedType>> {
    match *self.extra {
