...
fn reduce_sum(self: @Tensor<i8>, axis: usize, keepdims: bool) -> Tensor<i8> {
    ...
    if (*self.shape).len() == 1 {
        ...
        return TensorTrait::<i8>::new(output_shape.span(), output_data.span(), *self.extra);
    } else {
        ...
        if keepdims {
            ...
            return TensorTrait::<i8>::new(output_shape, output_data.span(), *self.extra);
        } else {
            return TensorTrait::<i8>::new(output_shape, output_data.span(), *self.extra);
        }
    }
...
///
/// # Returns
/// * An i8 value representing the accumulated sum along the specified axis.
fn accumulate_sum(
    mut input_data: Span<i8>, input_shape: Span<usize>, output_indices: Span<usize>, axis: usize
) -> i8 {
