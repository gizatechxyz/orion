...
fn reduce_sum(self: @Tensor<u32>, axis: usize, keepdims: bool) -> Tensor<u32> {
    ...
    if (*self.shape).len() == 1 {
        ...
        return TensorTrait::<u32>::new(output_shape.span(), output_data.span(), *self.extra);
    } else {
        ...
        if keepdims {
            ...
            return TensorTrait::<u32>::new(output_shape, output_data.span(), *self.extra);
        } else {
            return TensorTrait::<u32>::new(output_shape, output_data.span(), *self.extra);
        }
    }
...
fn accumulate_sum(
    mut input_data: Span<u32>, input_shape: Span<usize>, output_indices: Span<usize>, axis: usize
) -> u32 {
