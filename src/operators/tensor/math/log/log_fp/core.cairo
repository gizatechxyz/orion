...
use orion::operators::tensor::math::log::log_fp::fp8x23;
use orion::operators::tensor::math::log::log_fp::fp16x16;

/// Cf: TensorTrait::log docstring
fn log(self: @Tensor<FixedType>) -> Option<Tensor<FixedType>> {
    match *self.extra {
