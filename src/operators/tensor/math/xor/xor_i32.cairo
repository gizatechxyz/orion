...
use array::SpanTrait;
use orion::numbers::signed_integer::i32::i32_new;
...
fn xor(y: @Tensor<i32>, z: @Tensor<i32>) -> Tensor<usize> {
    ...
    loop {
        ...
        if (y_value == i32_new(0, true) || z_value == i32_new(0, true)) && y_value != z_value {
