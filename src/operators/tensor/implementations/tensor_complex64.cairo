...
impl Complex64Tensor of TensorTrait<complex64> {
    ...
    fn sequence_length(self: Array<Tensor<complex64>>) -> Tensor<u32> {
    ...
    fn sequence_at(sequence: Array<Tensor<complex64>>, position: Tensor<i32>) -> Tensor<complex64> {
        math::sequence_at::sequence_at(sequence, position)
    }

    fn sequence_construct(tensors: Array<Tensor<complex64>>) -> Array<Tensor<complex64>> {
        math::sequence_construct::sequence_construct(tensors)
    }


    fn sequence_empty() -> Array<Tensor<complex64>> {
        math::sequence_empty::sequence_empty::<complex64>()
    }
    ...
    fn sequence_erase(
        sequence: Array<Tensor<complex64>>, position: Option<Tensor<i32>>
    ) -> Array<Tensor<complex64>> {
        math::sequence_erase::sequence_erase(sequence, position)
    }

    fn sequence_insert(
        self: Array<Tensor<complex64>>, tensor: @Tensor<complex64>, position: Option<Tensor<i32>>
    ) -> Array<Tensor<complex64>> {
    ...
    fn concat_from_sequence(
        sequence: Array<Tensor<complex64>>, axis: i32, new_axis: Option<usize>
    ) -> Tensor<complex64> {
