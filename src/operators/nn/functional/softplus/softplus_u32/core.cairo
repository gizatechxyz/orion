...
use orion::operators::nn::functional::softplus::softplus_u32::fp16x16;
use orion::operators::nn::functional::softplus::softplus_u32::fp8x23;

/// Cf: NNTrait::softplus docstring
fn softplus_u32(z: @Tensor<u32>) -> Option::<Tensor<FixedType>> {
    match *z.extra {
