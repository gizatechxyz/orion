...
use orion::operators::nn::functional::softsign::softsign_u32::fp16x16;
use orion::operators::nn::functional::softsign::softsign_u32::fp8x23;

/// Cf: NNTrait::softsign docstring
fn softsign_u32(z: @Tensor<u32>) -> Option::<Tensor<FixedType>> {
    match *z.extra {
