...
use orion::operators::nn::functional::softsign::softsign_i8::fp16x16;
use orion::operators::nn::functional::softsign::softsign_i8::fp8x23;

/// Cf: NNTrait::softsign docstring
fn softsign_i8(z: @Tensor<i8>) -> Option<Tensor<FixedType>> {
    match *z.extra {
