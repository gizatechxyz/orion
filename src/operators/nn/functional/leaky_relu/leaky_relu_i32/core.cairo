...
use orion::operators::nn::functional::leaky_relu::leaky_relu_i32::fp16x16;
use orion::operators::nn::functional::leaky_relu::leaky_relu_i32::fp8x23;

/// Cf: NNTrait::leaky_relu docstring
fn leaky_relu_i32(z: @Tensor<i32>, alpha: @FixedType, ) -> Option::<Tensor<FixedType>> {
    match *z.extra {
