...
use orion::numbers::fixed_point::implementations::fp8x23::core::{FP8x23Impl, ONE, FP8x23Mul};
...
fn leaky_relu(z: @Tensor<i8>, alpha: @FixedType) -> Tensor<FixedType> {
    ...
    loop {
        ...
        if (current_index >= i8 { mag: 0, sign: false }) {
