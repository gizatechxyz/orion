...
fn tensor_greater_equal_2D() {
    ...
    assert(*result_a.data.at(4) == 1, 'result[4] = 0');
    ...
    assert(*result_b.data.at(4) == 1, 'result[4] = 0');
...
#[test]
#[available_gas(2000000)]
fn tensor_greater_equal_broadcast_2D() {
