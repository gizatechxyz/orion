...
mod tensor_2D {
    ...
    fn tensor_less_equal() {
        ...
        assert(*result_a.data.at(1) == 1, 'result[1] = 1');
        assert(*result_a.data.at(2) == 0, 'result[2] = 1');
        assert(*result_a.data.at(3) == 0, 'result[3] = 1');
        ...
        assert(*result_b.data.at(0) == 0, 'result[0] = 1');
        assert(*result_b.data.at(1) == 0, 'result[1] = 1');
        ...
        assert(*result_b.data.at(8) == 0, 'result[8] = 1');
    ...
    #[test]
    #[available_gas(200000000000)]
    fn tensor_less_equal_broadcast() {
        ...
        assert(*result_b.data.at(7) == 0, 'result[7] = 1');
        assert(*result_b.data.at(8) == 0, 'result[8] = 1');
        assert(*result_b.data.at(9) == 0, 'result[9] = 1');
        assert(*result_b.data.at(10) == 0, 'result[10] = 1');
        assert(*result_b.data.at(11) == 0, 'result[11] = 1');
