...
mod tensor_1D {
    ...
    use orion::tests::helpers::tensor::fixed_point::fp8x23::{fp_tensor_1x3_helper,fp_tensor_1x3_neg_helper, fp_tensor_2x3_helper, 
...
// ===== 3D ===== //
    ...
    fn tensor_onehot_tensor_2x2x2__axis_0() {
        ...
        assert((*result.data[9]) == FixedTrait::new_unscaled(1, true), 'result[9] = -1');
        assert((*result.data[10]) == FixedTrait::new_unscaled(2, true), 'result[10] = -2');
        assert((*result.data[11]) == FixedTrait::new_unscaled(3, true), 'result[11] = -3');
        ...
        assert((*result.data[16]) == FixedTrait::new_unscaled(0, false), 'result[16] = 0');
        assert((*result.data[17]) == FixedTrait::new_unscaled(1, false), 'result[17] = 1');
        assert((*result.data[18]) == FixedTrait::new_unscaled(2, false), 'result[18] = 2');
        assert((*result.data[19]) == FixedTrait::new_unscaled(3, false), 'result[19] = 3');
    ...
    fn tensor_onehot_tensor_3x2x2_3x2x1__axis_2() {
        ...
        assert((*result.data[9]) == FixedTrait::new_unscaled(6, false), 'result[9] = 6');
        assert((*result.data[10]) == FixedTrait::new_unscaled(7, false), 'result[10] = 7');
        assert((*result.data[11]) == FixedTrait::new_unscaled(3, false), 'result[11] = 3');
        assert((*result.data[12]) == FixedTrait::new_unscaled(8, false), 'result[12] = 8');
        assert((*result.data[13]) == FixedTrait::new_unscaled(9, false), 'result[13] = 9');
        assert((*result.data[14]) == FixedTrait::new_unscaled(4, false), 'result[14] = 4');
        assert((*result.data[15]) == FixedTrait::new_unscaled(10, false), 'result[15] = 10');
        assert((*result.data[16]) == FixedTrait::new_unscaled(11, false), 'result[16] = 11');
        assert((*result.data[17]) == FixedTrait::new_unscaled(5, false), 'result[17] = 5');
