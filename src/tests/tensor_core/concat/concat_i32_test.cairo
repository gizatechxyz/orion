...
mod tensor_1D {
    ...
    use orion::tests::helpers::tensor::i32::{i32_tensor_1x3_helper,i32_tensor_1x3_neg_helper, i32_tensor_2x3_helper, 
    i32_tensor_3x3_helper, i32_tensor_2x2_helper, i32_tensor_2x2_neg_helper, 
    i32_tensor_3x2_helper, i32_tensor_3x2x2_helper, i32_tensor_3x2x2_neg_helper,
    i32_tensor_2x2x2_helper, i32_tensor_2x2x2_neg_helper, i32_tensor_3x3x3_helper, i32_tensor_3x3x3_neg_helper};
    use orion::operators::tensor::core::{TensorTrait, Tensor, ExtraParams};
    use debug::PrintTrait;

    fn i32_tensor_3x2x1_helper() -> Tensor<i32> {
    ...
    fn tensor_onehot_tensor_1x3() {
        let tensor1 = i32_tensor_1x3_helper();
        let tensor2 = i32_tensor_1x3_neg_helper();
...
// ===== 2D ===== //
    ...
    fn tensor_onehot_tensor_2x2_axis_0() {
        let tensor1 = i32_tensor_2x2_helper();
        let tensor2 = i32_tensor_2x2_neg_helper();
    ...
    fn tensor_onehot_tensor_2x3_2x2__axis_1() {
        let tensor1 = i32_tensor_2x3_helper();
        let tensor2 = i32_tensor_2x2_neg_helper();
    ...
    fn tensor_onehot_tensor_3x2_2x2__axis_0() {
        let tensor1 = i32_tensor_3x2_helper();
        let tensor2 = i32_tensor_2x2_neg_helper();
...
// ===== 3D ===== //
    ...
    fn tensor_onehot_tensor_2x2x2__axis_0() {
        let tensor1 = i32_tensor_2x2x2_helper();
        let tensor2 = i32_tensor_2x2x2_neg_helper();
        let tensor3 = i32_tensor_2x2x2_helper();
    ...
    fn tensor_onehot_tensor_3x2x2__axis_0() {
        let tensor1 = i32_tensor_3x2x2_helper();
        let tensor2 = i32_tensor_3x2x2_neg_helper();
    ...
    fn tensor_onehot_tensor_3x2x2_3x2x1__axis_2() {
        let tensor1 = i32_tensor_3x2x2_helper();
        let tensor2 = i32_tensor_3x2x1_helper();
    ...
    fn dimension_not_the_same() {
        let tensor1 = i32_tensor_1x3_helper();
        let tensor2 = i32_tensor_2x3_helper();
    ...
    fn out_of_bound() {
        let tensor1 = i32_tensor_1x3_helper();
        let tensor2 = i32_tensor_1x3_helper();
    ...
    fn tensor_not_same_dimension_2_fail() {
        let tensor1 = i32_tensor_2x2_helper();
        let tensor2 = i32_tensor_3x2x2_helper();
    ...
    fn tensor_onehot_tensor_3x3x3__axis_2() {
        ...
        let tensor2 = i32_tensor_3x3x3_neg_helper();
