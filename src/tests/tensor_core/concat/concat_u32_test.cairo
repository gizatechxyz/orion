...
mod tensor_1D {
    ...
    use orion::tests::helpers::tensor::u32::{u32_tensor_1x3_helper, u32_tensor_2x3_helper, 
    u32_tensor_3x3_helper, u32_tensor_2x2_helper, 
    u32_tensor_3x2_helper, u32_tensor_3x2x2_helper,
    u32_tensor_2x2x2_helper, u32_tensor_3x3x3_helper};
    use debug::PrintTrait;

    fn u32_tensor_3x2x1_helper() -> Tensor<u32> {
    ...
    fn tensor_onehot_tensor_1x3() {
        let tensor1 = u32_tensor_1x3_helper();
...
// ===== 2D ===== //
    ...
    fn tensor_onehot_tensor_3x2_2x2__axis_0() {
        let tensor1 = u32_tensor_3x2_helper();
        let tensor2 = u32_tensor_2x2_helper();
...
// ===== 3D ===== //
    ...
    fn tensor_onehot_tensor_2x2x2__axis_0() {
        let tensor1 = u32_tensor_2x2x2_helper();
        let tensor2 = u32_tensor_2x2x2_helper();
        let tensor3 = u32_tensor_2x2x2_helper();
    ...
    fn tensor_onehot_tensor_3x2x2__axis_0() {
        let tensor1 = u32_tensor_3x2x2_helper();
        let tensor2 = u32_tensor_3x2x2_helper();
    ...
    fn tensor_onehot_tensor_3x2x2_3x2x1__axis_2() {
        let tensor1 = u32_tensor_3x2x2_helper();
        let tensor2 = u32_tensor_3x2x1_helper();
    ...
    fn dimension_not_the_same() {
        let tensor1 = u32_tensor_1x3_helper();
        let tensor2 = u32_tensor_2x3_helper();
    ...
    fn tensor_onehot_tensor_3x3x3__axis_2() {
        let tensor1 = u32_tensor_3x3x3_helper();
        let tensor2 = u32_tensor_3x3x3_helper();
