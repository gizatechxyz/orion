...
const ONE: felt252 = 8388608; // 2 ** 23
const ONE_u128: u128 = 8388608; // 2 ** 23
const ONE_u64: u64 = 8388608; // 2 ** 23
const HALF: felt252 = 4194304; // 2 ** 22
const HALF_u128: u128 = 4194304; // 2 ** 22
const MAX_u128: u128 = 2147483647; // 2 ** 31 - 1
