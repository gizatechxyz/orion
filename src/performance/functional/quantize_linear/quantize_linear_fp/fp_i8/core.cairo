...
use orion::performance::functional::quantize_linear::quantize_linear_fp::fp_i8::fp8x23;
use orion::performance::functional::quantize_linear::quantize_linear_fp::fp_i8::fp16x16;
