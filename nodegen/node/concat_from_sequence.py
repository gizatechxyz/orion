...
class Concat_from_sequence(RunAll):
    ...
    def concat_from_sequence_u32():
        def new_axis_zero():
            ...
            make_test([sequence], concatenated_tensor, "TensorTrait::concat_from_sequence(input_0, 1_i32, Option::Some(0))", name)
        ...
        def new_axis_one():
            ...
            make_test([sequence], concatenated_tensor, "TensorTrait::concat_from_sequence(input_0, 1_i32, Option::Some(1))", name)
        ...
        def new_axis_default():
            ...
            make_test([sequence], concatenated_tensor, "TensorTrait::concat_from_sequence(input_0, 1_i32, Option::None(()))", name)
