    ...
    def argmax_u32():
        def argmax_1D():
            def default_params():
                ...
                name = "argmax_u32_1D_default"
                make_node([x], [y], name)
                make_test(
                    [x], y, "input_0.argmax(0, Option::None(()), Option::None(()))", name)
            ...
            def keepdims_false():
                ...
                name = "argmax_u32_1D_keepdims_false"
                make_node([x], [y], name)
                make_test(
                    [x], y, "input_0.argmax(0, Option::Some(false), Option::None(()))", name)
            ...
            def last_index():
                ...
                name = "argmax_u32_1D_last_index"
                make_node([x], [y], name)
                make_test(
                    [x], y, "input_0.argmax(0, Option::None(()), Option::Some(true))", name)
        ...
        def argmax_2D():
            ...
            def keepdims_false():
                ...
                name = "argmax_u32_2D_keepdims_false"
                make_node([x], [y], name)
                make_test(
                    [x], y, "input_0.argmax(0, Option::Some(false), Option::None(()))", name)
        ...
        def argmax_3D():
            ...
            def keepdims_false():
                ...
                name = "argmax_u32_3D_keepdims_false"
                make_node([x], [y], name)
                make_test(
                    [x], y, "input_0.argmax(0, Option::Some(false), Option::None(()))", name)
    ...
    def argmax_i32():
        def argmax_1D():
            ...
            def keepdims_false():
                ...
                name = "argmax_i32_1D_keepdims_false"
                make_node([x], [y], name)
                make_test(
                    [x], y, "input_0.argmax(0, Option::Some(false), Option::None(()))", name)
        ...
        def argmax_2D():
            ...
            def keepdims_false():
                ...
                name = "argmax_i32_2D_keepdims_false"
                make_node([x], [y], name)
                make_test(
                    [x], y, "input_0.argmax(0, Option::Some(false), Option::None(()))", name)
        ...
        def argmax_3D():
            ...
            def keepdims_false():
                ...
                name = "argmax_i32_3D_keepdims_false"
                make_node([x], [y], name)
                make_test(
                    [x], y, "input_0.argmax(0, Option::Some(false), Option::None(()))", name)
    ...
    def argmax_i8():
        ...
        def argmax_2D():
            ...
            def keepdims_false():
                ...
                name = "argmax_i8_2D_keepdims_false"
                make_node([x], [y], name)
                make_test(
                    [x], y, "input_0.argmax(0, Option::Some(false), Option::None(()))", name)
        ...
        def argmax_3D():
            ...
            def keepdims_false():
                ...
                name = "argmax_i8_3D_keepdims_false"
                make_node([x], [y], name)
                make_test(
                    [x], y, "input_0.argmax(0, Option::Some(false), Option::None(()))", name)
    ...
    def argmax_fp16x16():
        def argmax_1D():
            def default_params():
                ...
                name = "argmax_fp16x16_1D_default"
                make_node([x], [y], name)
                make_test(
                    [x], y, "input_0.argmax(0, Option::None(()), Option::None(()))", name)
            ...
            def last_index():
                ...
                name = "argmax_fp16x16_1D_last_index"
                make_node([x], [y], name)
                make_test(
                    [x], y, "input_0.argmax(0, Option::None(()), Option::Some(true))", name)
        ...
        def argmax_2D():
            def default_params():
                ...
                name = "argmax_fp16x16_2D_default"
                make_node([x], [y], name)
                make_test(
                    [x], y, "input_0.argmax(0, Option::None(()), Option::None(()))", name)
            ...
            def keepdims_false():
                ...
                name = "argmax_fp16x16_2D_keepdims_false"
                make_node([x], [y], name)
                make_test(
                    [x], y, "input_0.argmax(0, Option::Some(false), Option::None(()))", name)
        ...
        def argmax_3D():
            def default_params():
                ...
                name = "argmax_fp16x16_3D_default"
                make_node([x], [y], name)
                make_test(
                    [x], y, "input_0.argmax(0, Option::None(()), Option::None(()))", name)
            ...
            def keepdims_false():
                ...
                name = "argmax_fp16x16_3D_keepdims_false"
                make_node([x], [y], name)
                make_test(
                    [x], y, "input_0.argmax(0, Option::Some(false), Option::None(()))", name)
            ...
            def last_index():
                ...
                name = "argmax_fp16x16_3D_last_index"
                make_node([x], [y], name)
                make_test(
                    [x], y, "input_0.argmax(0, Option::None(()), Option::Some(true))", name)
