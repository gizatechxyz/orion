...
class Matmul(RunAll):
    ...
    def matmul_u32():
        ...
        def matmul_2x2():
            ...
            make_node([a, b], [y], "matmul_u32_2x2")
        ...
        def matmul_2x1():
            ...
            make_node([a, b], [y], "matmul_u32_2x1")
        ...
        def matmul_1x2():
            ...
            make_node([a, b], [y], "matmul_u32_1x2")
    ...
    def matmul_i32():
        ...
        def matmul_2x2():
            ...
            make_node([a, b], [y], "matmul_i32_2x2")
        ...
        def matmul_2x1():
            ...
            make_node([a, b], [y], "matmul_i32_2x1")
        ...
        def matmul_1x2():
            ...
            make_node([a, b], [y], "matmul_i32_1x2")
    ...
    def matmul_fp8x23():
        def matmul_1D():
            ...
            a = Tensor(Dtype.FP8x23, a.shape, to_fp(a.flatten(), FixedImpl.FP8x23), FixedImpl.FP8x23)
            b = Tensor(Dtype.FP8x23, b.shape, to_fp(b.flatten(), FixedImpl.FP8x23), FixedImpl.FP8x23)
            y = Tensor(Dtype.FP8x23, y.shape, to_fp(y.flatten(), FixedImpl.FP8x23), FixedImpl.FP8x23)

            make_node([a, b], [y], "matmul_fp8x23_1d")
        ...
        def matmul_2x2():
            ...
            make_node([a, b], [y], "matmul_fp8x23_2x2")
        ...
        def matmul_2x1():
            ...
            make_node([a, b], [y], "matmul_fp8x23_2x1")
        ...
        def matmul_1x2():
            ...
            make_node([a, b], [y], "matmul_fp8x23_1x2")
    ...
    def matmul_fp16x16():
        def matmul_1D():
            ...
            a = Tensor(Dtype.FP16x16, a.shape, to_fp(a.flatten(), FixedImpl.FP16x16))
            ...
            make_node([a, b], [y], "matmul_fp16x16_1d")
        ...
        def matmul_2x2():
            ...
            make_node([a, b], [y], "matmul_fp16x16_2x2")
        ...
        def matmul_2x1():
            ...
            make_node([a, b], [y], "matmul_fp16x16_2x1")
        ...
        def matmul_1x2():
            ...
            make_node([a, b], [y], "matmul_fp16x16_1x2")
