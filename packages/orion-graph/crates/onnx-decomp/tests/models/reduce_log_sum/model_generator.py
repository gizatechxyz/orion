...
node1 = make_node('ReduceLogSum', ['x'], ['intermediate'])
node2 = make_node('ReduceLogSum', ['intermediate'], ['y'])

graph = make_graph([node1, node2],  
                    'reduce_log_sum_two_nodes', 
                    [x], 
                    [y]) 
...
onnx.save(onnx_model, 'reduce_log_sum_two_nodes.onnx')
