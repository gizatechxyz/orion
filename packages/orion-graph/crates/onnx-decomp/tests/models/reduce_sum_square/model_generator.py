...
node1 = make_node('ReduceSumSquare', ['x'], ['intermediate'])
node2 = make_node('ReduceSumSquare', ['intermediate'], ['y'])

graph = make_graph([node1, node2],  
                    'reduce_sum_square_two_nodes', 
                    [x], 
                    [y]) 
...
onnx.save(onnx_model, 'reduce_sum_square_two_nodes.onnx')
